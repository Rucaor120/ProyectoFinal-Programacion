...
public class Principal extends JFrame {
    ...
    private void cargarModulo(String modulo) {
        ...
        if (modulo.equals("Pinturas")) {
            ...
            modeloTabla.setColumnIdentifiers(new String[]{"ID", "Cliente", "Pintura", "Fecha", "Cantidad", "Total"});
    ...
    private void construirFormularioCompras() {
        ...
        btnGuardar.addActionListener(e -> {
            try {
                Compra c = new Compra(0, Integer.parseInt(txtClienteId.getText()), Integer.parseInt(txtPinturaId.getText()), 
                                      new Date(System.currentTimeMillis()), Integer.parseInt(txtCantidad.getText()), Double.parseDouble(txtPrecioTotal.getText()));
